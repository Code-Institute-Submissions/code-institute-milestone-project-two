...
$("#hotelsButton").on("click", function () {
    ...
    if (markersLoaded[placeType] == false || markersLoaded[placeType] == null) {
        loadMarkers(placeType, hotels, "assets/images/icons/hotelIcon.png", hotelDisplayFunction);
...
$("#todoButton").on("click", function () {
    ...
    if (markersLoaded[placeType] == false || markersLoaded[placeType] == null) {
        loadMarkers(placeType, thingsToDo, "assets/images/icons/thingsToDoIcon.png", thingsToDoDisplayFunction);
        markersLoaded[placeType] = true;
    }
});
...
$("#restaurantButton").on("click", function () {
    ...
    if (markersLoaded[placeType] == false || markersLoaded[placeType] == null) {
        loadMarkers(placeType, restaurants, "assets/images/icons/restaurantIcon.png", restaurantDisplayFunction);
        // getCardHtml();
        markersLoaded[placeType] = true;
    }
});
...
function getInfoFromPlacesAPI(placeKind, places) {
    ...
    $.each(places, function (key, place) {
        var request = {
            ...
            fields: ["name", "rating", "formatted_phone_number", "formatted_address", "icon", "reviews", "website", "photo"]
        };
